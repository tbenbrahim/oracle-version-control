...
/**
 * Abstract base class for all ovcs commands that process changes to the
 * database
 *
 * @author Tony BenBrahim <tony.benbrahim@10xdev.com>
 *
 */
public abstract class AbstractChangeCommand extends AbstractOvcsCommand {
	 ...
	 * Default constructor
	 */
	protected AbstractChangeCommand() {
		super();
	}
